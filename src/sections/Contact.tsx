    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col items-center gap-4 mt-28">
                <div className="flex items-center gap-2 font-light text-lg md:text-2xl">
                    ...
                    <a href="mailto:annampierretran@gmail.com" className="hover:text-purple transition-colors">annampierretran@gmail.com</a>
                </div>
                <div className="flex items-center gap-2 font-light text-lg md:text-2xl">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-purple" fill="none" viewBox="0 0 24 24" stroke="currentColor">
