import { star, resume_fr, resume_en } from "../assets";
            ...
            <article className='grid place-items-center h-full gap-2 text-center md:text-left'>
                <div className='flex flex-col gap-3 items-center md:items-start'>
                    ...
                    >
                        ...
                        <a
                            href={language == "en" ? resume_en : resume_fr}
                            target='_blank'
                            className='md:self-start relative cursor-none hover:cursor-pointer inline-flex overflow-hidden rounded-xl p-px'
                        >
